...
async function main() {
  ...
  // 4d — Orders (3 realistic demo contracts)
  ...
  const orders = [
    ...
    },
    {
      ...
      nombreEtages: '6',
      largeurGaineMm: '1400',
      profondeurGaineMm: '1600',
      hauteurGaineMm: '18000',
      materiauCabine: 'Acier Inoxydable Brossé',
      materiauPortes: 'Acier Inoxydable Brossé',
    ...
    },
    {
      ...
      nombreEtages: '8',
      largeurGaineMm: '1500',
      profondeurGaineMm: '1700',
      hauteurGaineMm: '12000',
      materiauCabine: 'Acier Inoxydable Miroir',
      materiauPortes: 'Verre Trempé',
      materiauParois: 'Acier Inoxydable Brossé',
      materiauSol: 'Granit Naturel',
  ...
  log('  📐 CAD Submissions...')
  const cads = [
    { order: oIds[0], engineeringType: 'DESSIN_TECH_1', engineerName: 'Karim Bensalem',  fileHash: 'a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2', fileMimeType: 'application/pdf', fileSizeBytes: 2456000, storageKey: 'cad/rmasc-g7h8i9/plan-installation.pdf', status: 'EN_ATTENTE' },
    { order: oIds[0], engineeringType: 'DESSIN_TECH_2', engineerName: 'Yasmine Hamidi',  fileHash: 'b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3', fileMimeType: 'application/pdf', fileSizeBytes: 1890000, storageKey: 'cad/rmasc-g7h8i9/dessin-2d-cabine.pdf', status: 'EN_ATTENTE' },
    { order: oIds[2], engineeringType: 'DESSIN_TECH_1', engineerName: 'Yasmine Hamidi',  fileHash: 'c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4',  fileMimeType: 'application/pdf', fileSizeBytes: 3200000, storageKey: 'cad/rmasc-m3n4o5/plan-installation.pdf', status: 'APPROUVE', approvedAt: new Date(now - 8 * d) },
    { order: oIds[2], engineeringType: 'DESSIN_TECH_2', engineerName: 'Yasmine Hamidi',  fileHash: 'd4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5',  fileMimeType: 'application/pdf', fileSizeBytes: 2100000, storageKey: 'cad/rmasc-m3n4o5/dessin-2d-cabine.pdf', status: 'APPROUVE', approvedAt: new Date(now - 5 * d) },
    { order: oIds[1], engineeringType: 'DESSIN_TECH_1', engineerName: 'Karim Bensalem',  fileHash: 'e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6', fileMimeType: 'application/pdf', fileSizeBytes: 1800000, storageKey: 'cad/rmasc-j0k1l2/plan-installation.pdf', status: 'EN_ATTENTE' },
  ]
